...
/*
	...
	#if defined (_UNICODE)
    #if defined( _DEBUG )
		  #pragma comment(lib, "..\\bin\\guilibdu114.lib") 
		  #pragma message("Automatically linking with guilibdu114.dll")    
	  #else
		  #pragma comment(lib, "..\\bin\\guilibu114.lib") 
		  #pragma message("Automatically linking with guilibu114.dll")
	  #endif
  #else
    #if defined( _DEBUG )
		  #pragma comment(lib, "..\\bin\\guilibd114.lib") 
		  #pragma message("Automatically linking with guilibd114.dll")    
	  #else
		  #pragma comment(lib, "..\\bin\\guilib114.lib") 
		  #pragma message("Automatically linking with guilib114.dll")
	  #endif
  #endif
#elif defined _GUILIB_STATIC_
	#if defined( _DEBUG )
		#pragma comment(lib, "..\\bin\\guilibstatic.lib") 

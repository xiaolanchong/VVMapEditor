...
public:
	...
	void Install(CFrameWnd* pFrame, CWnd* pHookWnd);					// connect to main frame
	...
	//NOTENOTE: 10/13/2004 load from explicite handle
	BOOL			LoadToolbar( HINSTANCE hInst, UINT nID) ;

...
void CGuiListEdit::PreSubclassWindow()
{
	...
	*/
	...
	m_MiniTool.AddButton(9,LST_DOWN,NULL,_T(""),DllResource.LoadString( IDS_ITEM_DOWN ));
	m_MiniTool.AddButton(11,LST_UP,NULL,_T(""),DllResource.LoadString( IDS_ITEM_UP ));
	m_MiniTool.AddButton(8,LST_DELETE,NULL,_T(""),DllResource.LoadString( IDS_DELETE ));
	m_MiniTool.AddButton(10,LST_INSERT,NULL,_T(""), DllResource.LoadString( IDS_INSERT ));
	m_MiniTool.AutoSize(TRUE);
	m_MiniTool.SetBorder(CGuiMiniTool::STYLEPRESS);
	m_MiniTool.SetCaption(DllResource.LoadString( IDS_OPTIONS ),CGuiMiniTool::ALIGN_LEFT);

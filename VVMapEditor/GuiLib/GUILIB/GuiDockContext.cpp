...
//		m_pDC->SetLayout(LAYOUT_LTR);
	...
	if (m_pBar->m_dwStyle & CBRS_SIZE_DYNAMIC)
	{
		...
		CMiniFrameWnd::CalcBorders(&m_rectFrameDragHorz, m_pBar->GetParentFrame()->GetStyle());
		CMiniFrameWnd::CalcBorders(&m_rectFrameDragVert, m_pBar->GetParentFrame()->GetStyle());
...
//		m_pDC->SetLayout(LAYOUT_LTR);
	...
	CMiniFrameWnd::CalcBorders(&m_rectActualFrameSize, m_pBar->GetParentFrame()->GetStyle());

...
// Data members -------------------------------------------------------------
private:
	static int ms_nRefCount;// used as counter to class objects
	//to handle construction and destroying common class data
public:
	enum {IDEDIT=100};
	CEdit m_wndEdit;
	static CStringArray ms_straWeekDays;// store default locale weekday names
	static CStringArray ms_straMonthNames;// store default locale month names
	CFont m_font;
